...
int checkName(LstHead *head, char* id){
    LstNode *node = head->next;
    while(node != NULL){
...
void removeNode(LstHead *head, char* name){
    LstNode *node = head->next;
    LstNode *tmp;
    while(node != NULL){
...
//     LstNode *node0 = newLstNode();
//     LstNode *node1 = newLstNode();
//     LstNode *node2 = newLstNode();
//     LstNode *node3 = newLstNode();
//     node0->name = "x";
//     node1->name = "y";
//     node2->name = "xcdsa";
//     node3->name = "xsdv";
